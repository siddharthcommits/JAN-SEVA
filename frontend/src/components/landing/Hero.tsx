            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
                <div className="lg:col-span-6 text-center lg:text-left">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <button className="bg-secondary text-white px-8 py-4 rounded-full font-bold text-[1rem] hover:scale-105 transition-all premium-shadow flex items-center justify-center gap-3" onClick={() => navigate('/login')}>
